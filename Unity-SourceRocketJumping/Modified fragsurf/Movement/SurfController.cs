...
namespace Fragsurf.Movement {
    public class SurfController {
            ...
            switch (_surfer.moveType) {
                ...
                if (_surfer.groundObject == null) {
                    ...
                    */
                    ...
                    wasSliding = false;
                    if (_surfer.moveData.isKnocked)
                    {
                     obtainKnockback();
                     //_surfer.moveData.isKnocked = false;
                    }
                    ...
                    */
                    ...
                    _surfer.moveData.velocity = Vector3.ClampMagnitude (new Vector3 (_surfer.moveData.velocity.x, _surfer.moveData.velocity.y, _surfer.moveData.velocity.z), maxVelocityMagnitude);
                    //_surfer.moveData.velocity.y = yVel;
        ...
        private void obtainKnockback()
        {
            _surfer.moveData.isKnocked = false;
            //_surfer.moveData.velocity += new Vector3 (1/ _surfer.moveData.distanceBetween.x, 1/_surfer.moveData.distanceBetween.y, 1/ _surfer.moveData.distanceBetween.z) * -200;
            Vector3 dist = _surfer.moveData.distanceBetween;
            //dist.y = -dist.y;
            //Debug.Log(_config.knockForce / (_surfer.moveData.distanceBetween.sqrMagnitude + 1f));
            //Debug.Log(dist * _config.knockForce / (_surfer.moveData.distanceBetween.sqrMagnitude + 1f));
            _surfer.moveData.velocity -=  dist*_config.knockForce/(_surfer.moveData.distanceBetween.sqrMagnitude+1f);

            //Debug.Log((1 / _surfer.moveData.distanceBetween.x, 1 / _surfer.moveData.distanceBetween.y, 1 / _surfer.moveData.distanceBetween.z));
            //Debug.Log(-_surfer.moveData.distanceBetween * 200);
               // _surfer.moveData.isKnocked = false;
        }
        /// <summary>
        /// 
